...
class Game:
    def __init__(self):
        ...
        self.window = pygame.display.set_mode((self.WIDTH, self.HEIGHT)) #Khởi tạo kích thước màn hình
        pygame.display.set_caption("Running Bro") #Tên game
        new_icon = pygame.image.load(r'images/icon.jpg') 
        pygame.display.set_icon(new_icon)#icon game
        self.clock = pygame.time.Clock()#Khởi tạo đồng hồ game
        self.all_sprites = Group()
        self.letters_group = Group()
        self.background = pygame.image.load(r"images/gp.jpg").convert()
        self.background = pygame.transform.scale(self.background, (self.WIDTH, self.HEIGHT))
        self.mbappe = Character(self.all_sprites)#Khởi tạo nhân vật
        ...
        Args:
            ...
            font (pygame.font.Font): Font cho văn bản.
            color (tuple): Màu của văn bản dưới dạng (R, G, B).
    ...
    def run(self):
        ...
        while running:
            ...
            pygame.display.flip()
    '''
    Hàm để reset lại game sau khi hoàn thành 1 màn chơi hoặc game over
    '''
    def reset_game(self):
